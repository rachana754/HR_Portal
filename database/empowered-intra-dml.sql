...
INSERT INTO `announcement` (`id`,`subject`, `description`,`color`,`is_active`, `create_date`, `last_modified_date`,`delete_date`) VALUES 
         (1,'Welcome to Empowered', 'What happens when you pair transformative technology with human empathy? You get solutions that work the way people do. Empowereds human-focused approach to software began nearly two decades ago. ','PURPLE','1', '2019-07-31 16:42:10', '2019-07-31 16:42:12', '2019-07-31 16:42:13'),

-- Dumping data for table hr-portal.profile: ~1 rows (approximately)
DELETE FROM `profile`;
...
INSERT INTO `announcement` (`id`,`subject`, `description`,`color`,`link`,`is_active`, `create_date`, `last_modified_date`,`delete_date` ) VALUES 
         (1,'Welcome to Empowered', 'What happens when you pair transformative technology with human empathy? You get solutions that work the way people do. Empowereds human-focused approach to software began nearly two decades ago. ','PURPLE','NULL','1', '2019-07-31 16:42:10', '2019-07-31 16:42:12', '2019-07-31 16:42:13'),
         (2,'9th Floor Restroom', 'Hello Team, The 9th floor restrooms have reopened. Seat covers have not been restocked as they must be ordered in a new size.Thank you for your patience during the remodel', 'ORANGE','NULL', '1', '2019-07-31 16:44:30', '2019-07-31 16:44:28', '2019-07-31 16:44:31'),
         (3,'Food Truck Schedule: August + The Dumpling Lady starting 8/15!', 'I�m excited! You�re going to be excited! The new Food Truck line up we have for you is Bonkers. We have 6 new food trucks. We have something for everyone this month. Please show all your support for our Food Truck vendors who so lovingly prepare some of the best food in Charlotte and they bring it right here, to our doorstep! If some of your favorites are gone, no worries they may be back for the next cycle.', 'BLUE','NULL', '1', '2019-07-31 16:46:18','2019-07-31 16:46:19','2019-07-31 16:46:20');
-- Add Config
INSERT INTO `hr-portal`.`config_specification` (`name`, `data_type`, `default_value`) VALUES 
	...
	('home.tell_hr.display', 'BOOLEAN', 'false');